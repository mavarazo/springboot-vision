package io.github.mavarazo.vision.insurance;

import io.github.mavarazo.vision.insurance.interceptor.CorrelationIdInterceptor;
import io.github.mavarazo.vision.insurance.interceptor.LoggingInterceptor;
...
public class InsuranceAdapterConfig {
    ...
    @Value("${vision.insurance.endpoint}")
    private String endpoint;

    @Bean
    public InsuranceAdapter shippingAdapter(final Tracer tracer, final ObservationRegistry observationRegistry) {
        ...
        return factory.createClient(InsuranceAdapter.class);
    }
}
